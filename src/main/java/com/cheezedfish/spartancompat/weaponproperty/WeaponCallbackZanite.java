...
public class WeaponCallbackZanite implements IWeaponCallback {
	...
	public void onTooltip(ToolMaterialEx arg0, ItemStack arg1, World arg2, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(TextFormatting.DARK_PURPLE  + StringHelper.translateString("zanite_scaling", "tooltip", SpartanCompatibility.MODID));
		if(GuiScreen.isShiftKeyDown())
		{
			tooltip.add(TextFormatting.ITALIC + " " + StringHelper.translateString("zanite_scaling.desc", "tooltip", SpartanCompatibility.MODID));
		}
	}
